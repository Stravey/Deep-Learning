...
# The MLP of the vision Transformer encoder is slightly different from the positioned FFN of the original Transformer encoder.
# First, here the activation function uses the Gaussian error linear unit (GELU),
# which can be considered as a smoother version of the ReLU.
...
class ViT(d2l.Classifier):
    ...
    def __init__(self, img_size, patch_size, num_hiddens, mlp_num_hiddens,
        ...
        # Add the cls token
        num_patches = self.patch_embedding.num_patches[0] * self.patch_embedding.num_patches[1]
