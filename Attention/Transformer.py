...
class TransformerEncoderBlock(nn.Module):
    """The encoder block for transformer encoder."""
...
class TransformerEncoder(nn.Module):
    ...
    def __init__(self, vocab_size, num_hiddens, ffn_num_hiddens, num_heads, num_blks, dropout, use_bias=False):
        ...
        for i in range(num_blks):
            self.blks.add_module("block"+str(i), TransformerEncoderBlock(num_hiddens,
...
# translate some sentences or test
...
# fill the masked attention weights with zero
